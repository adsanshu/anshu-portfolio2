...
function Sidebar({ t, menu, setMenu }) {
  return <aside className={`sidebar ${menu ? 'show' : ''}`}>
    <div className="brandRow"><div className="logo">AK</div><div><strong>Anshu Kumar Sharma</strong><small>Mechanical Engineering Student</small></div><button className="iconBtn closeSide" onClick={() => setMenu(false)}><X /></button></div>
